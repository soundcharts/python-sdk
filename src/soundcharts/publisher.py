...
class PublisherAsync:
    ...
    @staticmethod
    async def get_publisher_metadata(publisher_uuid):
        """
        Retrieve detailed profile information and contact metadata for a specific music publisher.
    ...
    @staticmethod
    async def get_publisher_by_ipi(ipi):
        """
        Retrieve detailed profile information and contact metadata for a specific music publisher.
    ...
    @staticmethod
    async def get_publisher_by_platform_id(platform, identifier):
        """
        Retrieve detailed profile information and contact metadata for a specific music publisher.
    ...
    @staticmethod
    async def get_ids(publisher_uuid, platform=None, offset=0, limit=100):
        """
        Get platform URLs belonging to this publisher.
